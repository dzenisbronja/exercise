...
// console.log(typeof parseFloat(mySrting)); //number
// console.log(typeof parseInt(mySrting)); //number
// console.log(typeof Number(mySrting)); //number
...
// console.log(typeof Number(mySrtingFloat));
